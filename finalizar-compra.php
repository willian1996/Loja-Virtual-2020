...
$res = $pdo->prepare("INSERT vendas SET total = :total, frete = :frete, sub_total = :sub_total, id_usuario = :id_usuario, pago = :pago, data = curDate() ");
	...
	if($comentario != ""){
		$res = $pdo->prepare("INSERT mensagem SET id_venda = :id_venda, texto = :texto, lida = :lida");
