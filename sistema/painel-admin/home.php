...
//echo $relatorio->cadastros_mensal(); 
//echo "<br>";
//echo $relatorio->cadastros_semestral();                             
...
<div class="card mb-3">
  <div class="card-header">
    ...
    Cadastros no mês atual</div>
  <div class="card-body">
    <canvas id="grafico_cadastro_mes" width="100%" height="30"></canvas>
  </div>
</div>
-->
...
<div class="card mb-3">
  <div class="card-header">
    ...
    Pedidos no mês atual</div>
  <div class="card-body">
    <canvas id="grafico" width="100%" height="30"></canvas>
  </div>
</div>
...
let json = <?php echo $relatorio->vendas_mensal();?>;
